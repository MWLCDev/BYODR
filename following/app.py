...
class FollowingApplication(Application):
    def __init__(self, event, hz, config_dir=os.getcwd()):
        ...
        self._config_hash = -1
        self.controller = FollowingController(model_path="./models/yolov8n_coco(imgsz480x640_FP16_485epoch).engine", user_config_args=self.get_user_config_file_contents(), event=quit_event, hz=hz)
