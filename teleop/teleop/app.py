    ...
    try:
        main_app = web.Application(
            [
                ...
                (r"/ws/send_mobile_controller_commands", MobileControllerCommands, dict(fn_control=throttle_control)),
                ...
                (r"/teleop/user/options", ApiUserOptionsHandler, dict(user_options=(UserOptions(application.get_user_config_file())), fn_on_save=on_options_save)),
