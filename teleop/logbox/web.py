...
_trigger_names = {TRIGGER_SERVICE_START: "startup", TRIGGER_SERVICE_END: "shutdown", TRIGGER_PHOTO_SNAPSHOT: "photo", TRIGGER_DRIVE_OPERATOR: "teleop", TRIGGER_DRIVE_TRAINER: "train"}
...
class WebEventViewer(object):
    ...
    def __call__(self, *args, **kwargs):
        _steering_scale = _float_or_default(kwargs.get("pil_steering_scale"), default=1.0)
